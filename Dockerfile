...
EXPOSE 6091
ENV APP_DOMAIN=coupon-clipper-stopandshop.herokuapp.com LOG_LEVEL=info DATABASE_URL=postgres://user:pass@host/db PORT=6091 SESSION_SECRET=mysecret CRYPT_KEEPER_KEY=cryptickey TICK_INTERVAL_SECONDS=360 EMAIL_FROM=noreply@localhost EMAIL_PASSWORD=serverpass EMAIL_SERVER_ADDR=localhost:25 EMAIL_USERNAME=bobbeh ENVIRONMENT=production
